 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ru.serioussem.se.money.service.impl.AccountLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ru.serioussem.se.money.service.impl.AccountLocalServiceImpl
 * @generated
 */
public abstract class AccountLocalServiceBaseImpl
	...
	public Account createAccount(long Id) {
		return accountPersistence.create(Id);
	}
	...
	public Account deleteAccount(long Id) throws PortalException {
		return accountPersistence.remove(Id);
	}
	...
	public Account fetchAccount(long Id) {
		return accountPersistence.fetchByPrimaryKey(Id);
	}
	...
	public Account getAccount(long Id) throws PortalException {
		return accountPersistence.findByPrimaryKey(Id);
	}
