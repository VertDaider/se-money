...
import ru.serioussem.se.money.model.impl.AccountImpl;
import ru.serioussem.se.money.model.impl.AccountModelImpl;
...
public class AccountPersistenceImpl
	...
	public Account updateImpl(Account account) {
		...
		entityCache.putResult(AccountImpl.class, account, false, true);
	...
	private static final Set<String> _badColumnNames = SetUtil.fromArray(
		new String[] {"Id", "Name", "Balance", "Total"});
