 ...
 * <code>ru.serioussem.se.money.service.impl.AccountLocalServiceImpl</code> and
...
public class AccountLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>ru.serioussem.se.money.service.impl.AccountLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Account createAccount(long Id) {
		return getService().createAccount(Id);
	}
	 ...
	 */
	public static Account deleteAccount(long Id) throws PortalException {
		return getService().deleteAccount(Id);
	}
	...
	public static Account fetchAccount(long Id) {
		return getService().fetchAccount(Id);
	}
	 ...
	 * @throws PortalException if a account with the primary key could not be found
	 */
	public static Account getAccount(long Id) throws PortalException {
		return getService().getAccount(Id);
	}
