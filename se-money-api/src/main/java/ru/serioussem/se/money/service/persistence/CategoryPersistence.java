...
public interface CategoryPersistence extends BasePersistence<Category> {
	 ...
	 */
	public java.util.List<Category> findByType(int Type);
	 ...
	 */
	public java.util.List<Category> findByType(int Type, int start, int end);
	 ...
	 */
	public java.util.List<Category> findByType(
